...
function campaignOne__may() {
  ...
  let campaignArr = [
    ...
    [.replaceAll('emSphere','スカウト！ジェムスフィア','scout theme'],
    ...
    [.replaceAll('hostic','朧な影＊ゴースティックハロウィン','event'],
    ...
    [.replaceAll('reenGo','社会人☆門出を出発新GO！','event'],
    ...
    [.replaceAll('raduationScout','スカウト！共に進む先','scout theme'],
    [.replaceAll('raduationEvent','波乱の夢の先／君と立つグラデュエーション','event'],
